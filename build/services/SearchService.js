...
var SearchService = /** @class */ (function () {
    ...
    SearchService.category = function (req, res) {
    ...
    SearchService.subCategory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, subCategoryItem, subCategoryList_1, response_2, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        subCategoryList_1 = [];
                        subCategoryItem.map(function (item) {
                            var Name = item.Name, ID = item.ID;
                            var obj = {
                                id: ID,
                                name: Name,
                            };
                            subCategoryList_1.push(Name);
                        });
                        response_2 = {
                            success: true,
                            data: {
